...
cfp2(lamval1 x)
{
    ...
    lamval1 n = LAMOPR_lst_uncons1(env);
    lamval1 (*k)(lamval1 a) = (lamval1 (*)(lamval1))LAMOPR_lst_uncons1(LAMOPR_lst_uncons2(env));
...
kfact(lamval1 x)
{
    ...
    if (((lamval1_int)tmp0)->data)
    {
        ...
        lamval1 env0 = LAMOPR_lst_cons(k, LAMOPR_lst_nil());
        lamval1 env1 = LAMOPR_lst_cons(n, env0);
        tmp2 = LAMVAL_cfp1(cfp2, env1);
...
fact(lamval1 x)
{
    ...
    tmp0 = LAMVAL_cfp1(cfp1, LAMOPR_lst_nil());
